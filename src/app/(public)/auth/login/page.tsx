    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-0 left-1/4 h-[500px] w-[500px] rounded-full bg-blue-500/5 blur-3xl" />
                <div className="absolute bottom-0 right-1/4 h-[400px] w-[400px] rounded-full bg-violet-500/5 blur-3xl" />
            </div>
